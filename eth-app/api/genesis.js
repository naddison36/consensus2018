...
const HardcodedSigner_1 = require("../ethereum/signers/HardcodedSigner");
const VError = require("verror");
const GenesisContract_1 = require("../ethereum/GenesisContract");
...
class Genesis {
    constructor() {
        ...
        this.provider = new ethers_1.providers.JsonRpcProvider(config.chain.rpc_url, "unspecified");
    }
    ...
    async init() {
        try {
            this.signerFactory = new HardcodedSigner_1.default();
            ...
            this.genesisContract = new GenesisContract_1.default({
