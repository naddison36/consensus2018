...
var AbstractPrivateKeySigner_1 = require("./AbstractPrivateKeySigner");
var HardcodedSignerFactory = /** @class */ (function () {
    function HardcodedSignerFactory() {
    }
    HardcodedSignerFactory.prototype.create = function (address, provider) {
        var signer = new HardcodedSigner(address, provider);
        return signer.loadSigner();
    };
    return HardcodedSignerFactory;
}());
exports.default = HardcodedSignerFactory;
var HardcodedSigner = /** @class */ (function (_super) {
    __extends(HardcodedSigner, _super);
    function HardcodedSigner() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    HardcodedSigner.prototype.getPrivateKey = function (address) {
    ...
    return HardcodedSigner;
}(AbstractPrivateKeySigner_1.default));
